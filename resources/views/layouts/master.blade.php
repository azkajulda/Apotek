            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="tables-basic.html">Data Obat</a></li>
                        <li><i class="fa fa-table"></i><a href="tables-data.html">Data Konsumen</a></li>
                        <li><i class="fa fa-table"></i><a href="tables-basic.html">Data Distributor</a></li>
                        <li><i class="fa fa-table"></i><a href="tables-data.html">Data Produsen</a></li>
                        <li><i class="fa fa-table"></i><a href="tables-basic.html">Data Karyawan</a></li>
                        <li><i class="fa fa-table"></i><a href="tables-data.html">Data Dokter</a></li>
                    </ul>
                </li>
                <li><a href="#">Data Kas Apotek</a></li>
                ...
                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Penerimanaan Return Obat</a></li>
