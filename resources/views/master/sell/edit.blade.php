    ...
    <div class="page-header float-right">
        <div class="page-title">
            <ol class="breadcrumb text-right">
                ...
                <li class="active"><a href="#">Edit Data Penjualan</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Edit</strong> Data Penjualan
                        </div>
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{ route('update-sell', $sales->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="sales_medicine" id="sales_medicine" class="form-control">
                                            ...
                                            @foreach ($medicines as $medicine)
                                                <option value="{{ $medicine->id }}" {{ ($medicine->id == $sales->id_obat) ? "selected" : "" }}>{{ $medicine->nama_obat }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="sales_consument" id="sales_consument" class="form-control">
                                            ...
                                            @foreach ($consumens as $consumen)
                                                <option value="{{ $consumen->id }}" {{ ($consumen->id == $sales->id_konsumen) ? "selected" : "" }}>{{ $consumen->nama_konsumen }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="sales_doctor" id="sales_doctor" class="form-control">
                                            ...
                                            @foreach ($doctors as $doctor)
                                                <option value="{{ $doctor->id }}" {{ ($doctor->id == $sales->id_dokter) ? "selected" : "" }}>{{ $doctor->nama_dokter }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="date" id="text-input" name="sales_date" placeholder="" class="form-control" value="{{ $sales->tanggal_penjualan }}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="number" id="text-input" name="sales_qty" placeholder="" class="form-control" value="{{ $sales->qty }}">
