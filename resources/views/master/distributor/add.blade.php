                            ...
                            <form action="{{ route('store-distributor') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="distributor_name" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : Ridwan Kusuma Perdana</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="distributor_address" id="textarea-input" rows="3" placeholder="" class="form-control"></textarea>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="text" id="text-input" name="distributor_city" placeholder="" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="text" id="text-input" name="distributor_phone" placeholder="" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="distributor_email" placeholder="" class="form-control">
