                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{ route('uploadDokter') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kode Dokter</label></div>
                                    <div class="col-6 col-md-3">
                                        <input type="text" id="text-input" name="kode_dokter" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : D102</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="nama_dokter" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : Ridwan Kusuma Perdana</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="number" id="text-input" name="telepon" placeholder="" class="form-control">
