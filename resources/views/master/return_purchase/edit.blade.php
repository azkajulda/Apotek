    ...
    <div class="page-header float-right">
        <div class="page-title">
            <ol class="breadcrumb text-right">
                ...
                <li class="active">Edit Return Pembelian</li>
            </ol>
        </div>
    </div>
@endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Edit</strong> Data Return Pembelian
                        </div>
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{ route('update-purchase-return', $purchase_returns->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="purchase_return_medicine" id="purchase_return_medicine" class="form-control">
                                            ...
                                            @foreach ($medicines as $medicine)
                                                <option value="{{ $medicine->id }}" {{ ($purchase_returns->id_obat == $medicine->id) ? "selected" : "" }}>{{ $medicine->nama_obat }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="purchase_return_distributor" id="purchase_return_distributor" class="form-control">
                                            ...
                                            @foreach ($distributors as $distributor)
                                                <option value="{{ $distributor->id }}" {{ ($purchase_returns->id_distributor == $distributor->id) ? "selected" : "" }}>{{ $distributor->nama_distributor }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="number" id="text-input" name="purchase_return_qty" placeholder="" class="form-control" value="{{ $purchase_returns->qty }}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="date" id="text-input" name="purchase_return_date" placeholder="" class="form-control" value="{{ $purchase_returns->tanggal_return }}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="purchase_return_caption" id="textarea-input" rows="3" placeholder="" class="form-control">{{ $purchase_returns->keterangan }}</textarea>
