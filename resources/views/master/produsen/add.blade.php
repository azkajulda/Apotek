                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{ route('store-produsen') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Pabrik</label></div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="produsen_name" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : PT.Medion Farma Jaya</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="produsen_address" id="textarea-input" rows="3" placeholder="" class="form-control"></textarea>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="text" id="text-input" name="produsen_phone" placeholder="" class="form-control">
