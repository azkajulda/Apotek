                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{ route('updateKas',$kas->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal</label></div>
                                    <div class="col-6 col-md-3">
                                        <input type="date" id="text-input" name="tanggal" placeholder="" value="{{$kas->tanggal}}" class="form-control"><small class="form-text text-muted"></small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" value="{{$kas->keterangan}}" name="keterangan" placeholder="" class="form-control"><small class="form-text text-muted"></small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="number" id="text-input" name="nominal" value="{{$kas->nominal}}" placeholder="" class="form-control"><small class="form-text text-muted"></small>
