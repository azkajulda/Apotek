                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Tambah</strong> Data Karyawan
                        </div>
                        <div class="card-body card-block">
                            ...
                            @endif
                            <form action="{{ route('uploadKaryawan') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kode Karyawan</label></div>
                                    <div class="col-6 col-md-3">
                                        <input type="text" id="text-input" name="kode_karyawan" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : K102</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="nama_karyawan" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : Ridwan Kusuma Perdana</small>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="jabatan" placeholder="" class="form-control"><small class="form-text text-muted">*Contoh : Ridwan Kusuma Perdana</small>
